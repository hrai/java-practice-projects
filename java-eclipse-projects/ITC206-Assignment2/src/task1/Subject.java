...
public class Subject {
    ...
    /* Check if entered subject code is true */
    ...
    public static ArrayList<String> allDisciplines(ArrayList<Subject> subjects) {
        ...
        for(Subject sub: subjects) {
            ...
            String discipline = subjectCode.substring(0, 3);    //getting discipline 
            
            disciplines.add(discipline);    //adding discipline to ArrayList
        	
            /*
            //check if the discipline already exists
            for(String dis: disciplines) {
            	if(disciplines.size() == 0 || !dis.equals(discipline)) {
            		disciplines.add(discipline);    //adding discipline to ArrayList
            	}
            }
            */
